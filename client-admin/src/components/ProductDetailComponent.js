...
class ProductDetail extends Component {
  ...
  loadProduct = async () => {
    ...
    try {
      const response = await axios.get(`${process.env.REACT_APP_API_BASE_URL}/api/admin/products/${id}`);
  ...
  apiGetCategories() {
    axios
      .get(`${process.env.REACT_APP_API_BASE_URL}/api/admin/categories`)
      .then((res) => {
  ...
  apiPostProduct(prod) {
    axios
      .post(`${process.env.REACT_APP_API_BASE_URL}/api/admin/products`, prod)
      .then((res) => {
        this.setState({
          successMessage: 'Thêm sản phẩm thành công!',
          errorMessage: '',
  ...
  apiPutProduct(id, prod) {
    ...
    axios
      .put(`${process.env.REACT_APP_API_BASE_URL}/api/admin/products/${id}`, prod)
      .then((res) => {
